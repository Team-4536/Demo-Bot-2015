...
public class DriveTrain {
     ...
     * It takes in four arguments - the two PWM channels for the Talons, and the gyro analog channel.
     */
...
public static int fieldSide() {
	 ...
	 */
	public void updateAngle (boolean calibrationButton, boolean toteLimitSwitchValue) {
		
		currentAngle = angleCorrection + gyroSensor.getAngle();
		
		if (toteLimitSwitchValue && !prevToteLimitSwitchValue) {
		...
		prevToteLimitSwitchValue = toteLimitSwitchValue;
